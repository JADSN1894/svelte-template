<script lang="ts">
	...
	pageTitleState.pageTitle = 'Register';
</script>
				...
				<div class="hero min-h-full rounded-l-xl bg-base-200">
					<div class="hero-content py-12">
						<div class="max-w-md">
							...
							<p class="py-2">
								✓ <span class="font-semibold">Redux toolkit</span> and other utility libraries configured
							</p>
							<p class="py-2">
								✓ <span class="font-semibold">Calendar, Modal, Sidebar </span> components
							</p>
				...
				<form>
					<div class="mb-4">
						<div class="form-control w-full mt-4">
							...
							<input type="text" placeholder="" class="input input-bordered w-full" value="" />
						</div>
						<div class="form-control w-full mt-4">
							<span class="label"
						...
						<div class="form-control w-full mt-4">
							...
							<input type="password" placeholder="" class="input input-bordered w-full" value="" />
						</div>
					</div>
